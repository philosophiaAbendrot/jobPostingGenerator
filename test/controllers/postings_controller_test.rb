...
class PostingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create posting" do
    assert_difference('Posting.count') do
      post postings_url, params: { posting: { company_name: @posting.company_name, duties: @posting.duties, duties_name: @posting.duties_name, link: @posting.link, position_name: @posting.position_name, qualifications: @posting.qualifications, qualifications_name: @posting.qualifications_name, summary: @posting.summary, summary_name: @posting.summary_name } }
    end
  ...
  test "should update posting" do
    patch posting_url(@posting), params: { posting: { company_name: @posting.company_name, duties: @posting.duties, duties_name: @posting.duties_name, link: @posting.link, position_name: @posting.position_name, qualifications: @posting.qualifications, qualifications_name: @posting.qualifications_name, summary: @posting.summary, summary_name: @posting.summary_name } }
